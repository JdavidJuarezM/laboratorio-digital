    ...
    >
      ...
      >
        ...
        <main className="w-full md:w-4/5 flex flex-col gap-4 relative order-1 md:order-2 flex-grow h-full">
          ...
          {/* Header del Huerto */}
          <div className="bg-gray-800/50 p-2 md:p-4 rounded-xl flex justify-between items-center backdrop-blur-sm shadow-lg">
            <div>
              ...
              <div className="flex items-center gap-2 text-xs md:text-sm text-blue-200 mt-1 bg-black/20 px-2 md:px-3 py-1 rounded-lg w-fit">
        ...
        */}
        <aside className="w-full md:w-1/5 flex flex-row md:flex-col items-center justify-center gap-4 md:gap-6 relative z-30 order-2 md:order-1 mt-0 md:mt-4 p-2 md:p-0 bg-transparent">
          ...
          >
            ...
            <div className="absolute top-2 left-2 w-2 h-2 md:w-3 md:h-3 rounded-full bg-[#4A2511] shadow-inner"></div>
            <div className="absolute top-2 right-2 w-2 h-2 md:w-3 md:h-3 rounded-full bg-[#4A2511] shadow-inner"></div>
            <div className="absolute bottom-2 left-2 w-2 h-2 md:w-3 md:h-3 rounded-full bg-[#4A2511] shadow-inner"></div>
            <div className="absolute bottom-2 right-2 w-2 h-2 md:w-3 md:h-3 rounded-full bg-[#4A2511] shadow-inner"></div>
          </div>
          ...
          <div className="flex flex-row md:flex-col gap-8 md:gap-6 w-full items-center justify-center py-2 md:pb-6 z-10">
            {["agua", "sol"].map((toolId) => (
              <div key={toolId} className="relative group">
                {/* Gancho visual (adaptado para ambos modos) */}
                <div className="absolute -top-2 md:-top-3 left-1/2 -translate-x-1/2 w-2 h-3 md:h-4 bg-gray-400 rounded-full shadow-md z-0"></div>
                ...
                {pasoTutorial === 1 && toolId === "agua" && (
                  <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 md:left-full md:top-0 md:ml-4 md:translate-x-0 w-40 z-50">
                    <TutorialBubble
