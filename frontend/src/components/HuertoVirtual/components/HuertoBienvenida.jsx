...
function HuertoBienvenida({onStart}) {
    ...
    return (
        <div
            className="relative w-full h-full flex flex-col items-center justify-center text-center p-8 animate-fadeIn">
            {/* Botón Maestro */}
            <button
      ...
      `}</style>
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-2xl mb-8">
                Aquí podrás plantar, cuidar y ver crecer tu propia planta.
            </p>
