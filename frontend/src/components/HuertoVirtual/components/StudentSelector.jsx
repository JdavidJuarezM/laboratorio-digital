    ...
    return (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            <motion.div initial={{scale: 0.8}} animate={{scale: 1}}
                        className="bg-white rounded-3xl shadow-2xl p-8 max-w-lg w-full text-center border-4 border-blue-100 flex flex-col max-h-[80vh]">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 overflow-y-auto p-2 custom-scrollbar flex-1">
                        {alumnos.length > 0 ? (
                            ...
                            <div
                                className="col-span-2 text-gray-400 py-8 border-2 border-dashed border-gray-300 rounded-xl bg-gray-50">
