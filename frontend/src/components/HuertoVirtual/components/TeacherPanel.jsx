                ...
                <div className="flex-1 overflow-hidden flex flex-col bg-slate-50">
                    ...
                    {!isAuthenticated ? (
                        <div className="flex-1 flex flex-col items-center justify-center p-8">
                            <div
                                className="bg-white p-10 rounded-2xl shadow-xl border border-gray-200 max-w-md w-full text-center">
                            ...
                            <div className="flex-1 p-8 overflow-y-auto custom-scrollbar">
                                ...
                                {activeTab === 'dashboard' && (
                                    <div className="animate-fadeIn max-w-4xl mx-auto">
                                        ...
                                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-8">
                                            <h4 className="text-sm font-bold text-gray-400 uppercase mb-3">Agregar
                                                Nuevo</h4>
                                            <form onSubmit={handleAgregarAlumno} className="flex gap-3">
                                                ...
                                                />
                                                <button
                                                    className="bg-green-500 hover:bg-green-600 text-white px-6 rounded-xl font-bold transition-colors shadow-sm flex items-center gap-2">
                                                    <span>+</span> Agregar
                                                </button>
                                            </form>
                                        </div>
                                        ...
                                        {loading ? (
                                            <div className="text-center py-12">
                                                <div
                                                    className="animate-spin inline-block w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full"></div>
                                                    ...
                                                    {alumnos.map(a => (
                                                        <tr key={a.id} className="hover:bg-slate-50 transition-colors">
                                                            <td className="p-4 font-bold text-gray-700 flex items-center gap-3">
                                                                <div
                                                                    className="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm">👤
                                                                </div>
                                                                {a.nombre}
                                                            </td>
                                                            <td className="p-4">
                                            <span
                                                className={`px-3 py-1 rounded-full text-xs font-bold border ${a.etapa > 3 ? 'bg-green-50 text-green-700 border-green-200' : 'bg-yellow-50 text-yellow-700 border-yellow-200'}`}>
                                                Nivel {a.etapa}
                                            </span>
                                                            </td>
                                ...
                                {activeTab === 'preguntas' && (
                                    <div className="animate-fadeIn max-w-5xl mx-auto">
                                        <div
                                            className="flex justify-between items-center mb-8 sticky top-0 bg-slate-50 py-4 z-10 border-b border-slate-200">
                                            <div>
                                                <h3 className="text-3xl font-bold text-slate-800">Editor de
                                                    Cuestionario</h3>
                                                <p className="text-gray-500">Personaliza las preguntas de cada
                                                    etapa.</p>
                                            </div>
                                            <button
                                                ...
                                                <div key={etapa}
                                                    ...
                                                    <div
                                                        ...
                                                        <h4 className="font-bold text-xl text-orange-600 flex items-center gap-2">
                                                            <span
                                                                className="bg-orange-100 p-2 rounded-lg text-2xl">🌱</span>
                                                            Etapa {etapa}
                                                        </h4>
                                                        <span
                                                            className="text-xs font-bold bg-gray-100 text-gray-500 px-3 py-1 rounded-full">
                                                    ...
                                                    <div className="space-y-6">
                                                        {preguntas[etapa].map((p, idx) => (
                                                            ...
                                                            >
                                                                ...
                                                                {/* Checkbox Habilitar */}
                                                                <div
                                                                    className="absolute top-4 right-12 flex items-center gap-2 z-10">
                                                                    <label
                                                                ...
                                                                <div className="mb-4 pr-32">
                                                                    <label
                                                                        className="block text-xs font-bold text-blue-600 uppercase mb-1">Pregunta {idx + 1}</label>
                                                                    <input
