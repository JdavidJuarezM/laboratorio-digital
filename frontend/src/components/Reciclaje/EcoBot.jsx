        ...
        <>
            <div id="ecoBot" ref={botRef}>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' width="100%" height="100%">
                    ...
                    <circle ref={pupilLeftRef} id='pupil-left' cx='40' cy='30' r='4' fill='#000'
                            style={{transition: 'transform 0.1s ease-out'}}/>
                    <circle ref={eyelidRightRef} id='eyelid-right' cx='70' cy='30' r='8' fill='#fff'/>
                    <circle ref={pupilRightRef} id='pupil-right' cx='70' cy='30' r='4' fill='#000'
                            style={{transition: 'transform 0.1s ease-out'}}/>
                    <path ref={mouthRef} id="bot-mouth" d='M35 65 Q50 85 65 65' stroke='#388E3C' strokeWidth='4'
                          fill='none' style={{transition: 'd 0.3s ease-in-out'}}/>
