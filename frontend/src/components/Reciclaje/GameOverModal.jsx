        ...
        >
            ...
            >
                ...
                <div className="text-left text-lg text-gray-700 space-y-2 my-6 max-w-xs mx-auto">
                    <div>♻️ <strong>Objetos Reciclados:</strong> <span
                        className="font-bold text-gray-900">{stats.itemsCorrect}</span></div>
                    <div>⚡ <strong>Poderes Usados:</strong> <span
                        className="font-bold text-gray-900">{stats.powerUpsCollected}</span></div>
                    <div>💣 <strong>Bombas Evitadas:</strong> <span
                        className="font-bold text-gray-900">{stats.bombsAvoided}</span></div>
                </div>
