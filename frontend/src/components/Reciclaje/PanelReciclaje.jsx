...
const PanelReciclaje = ({onClose}) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100] p-4 backdrop-blur-sm">
            <div
                className="bg-white w-full max-w-4xl h-[85vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden border-4 border-green-500">
                ...
                <div className="bg-green-600 p-4 flex justify-between items-center text-white shadow-md">
                    ...
                    <button onClick={onClose}
                            className="text-white hover:bg-green-700 px-4 py-1 rounded-full font-bold transition border-2 border-white/30">
                        Cerrar
                    </button>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-green-50 custom-scrollbar">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 border-2 border-green-100">
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Emoji
                                    (Icono)</label>
                                <input
                                    name="icono"
                            ...
                            <div className="md:col-span-1">
                                <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Tipo de
                                    Contenedor</label>
                                <select
                                    name="tipo"
                            ...
                            <div>
                                <button type="submit"
                                        className="w-full bg-green-600 text-white font-bold py-3 rounded-xl hover:bg-green-700 shadow-lg transform active:scale-95 transition">
                                    Guardar
                                </button>
                            </div>
                        </form>
                                    ...
                                    <div key={item.id}
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    className={`text-xs text-white px-2 py-1 rounded-full font-bold ${getBinColor(item.tipo)}`}>
