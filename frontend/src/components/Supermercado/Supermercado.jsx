      ...
      <div className="flex-1 w-full p-4 md:p-6 flex flex-col relative z-10 h-screen box-border">
        ...
        <div className="flex flex-col md:flex-row gap-6 flex-1 min-h-0">
          ...
          <aside className="w-full md:w-1/4 h-full flex flex-col min-h-0">
             ...
             <div className="h-full bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden flex flex-col">
          ...
          <main className="flex-1 bg-white/60 backdrop-blur-sm rounded-2xl border border-white shadow-inner p-4 md:p-6 flex flex-col min-h-0 relative">
            ...
            <div className="w-full bg-gray-200 rounded-full h-3 mb-4 overflow-hidden border border-gray-300 shrink-0">
              <div
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                {loadingProducts ? (
                <div className="flex items-center justify-center h-full text-gray-500 font-bold text-xl animate-pulse">
                    📦 Cargando productos...
                </div>
                ) : gameState === "shopping" ? (
                <ProductGrid
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[60] p-4 backdrop-blur-sm">
          <div className="bg-white p-8 rounded-2xl max-w-md text-center shadow-2xl animate-bounce-in">
            ...
            <ul className="text-left space-y-3 mb-8 text-gray-700 text-lg">
              <li className="flex items-start gap-2"><span className="text-xl">📋</span> Mira tu lista de compras a la izquierda.</li>
              <li className="flex items-start gap-2"><span className="text-xl">🔍</span> Encuentra los productos en los estantes.</li>
              <li className="flex items-start gap-2"><span className="text-xl">🧮</span> Resuelve la operación matemática.</li>
              <li className="flex items-start gap-2"><span className="text-xl">💰</span> ¡Completa la lista y paga en caja!</li>
            </ul>
            <button
          ...
          <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-sm">
            ...
            <form onSubmit={handleAdminAccess} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button type="button" onClick={()=>setShowAdminLogin(false)} className="flex-1 py-3 text-gray-500 font-bold hover:bg-gray-100 rounded-xl transition-colors">Cancelar</button>
                <button type="submit" className="flex-1 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold shadow-md transition-colors">Entrar</button>
              </div>
            </form>
          </div>
        </div>
