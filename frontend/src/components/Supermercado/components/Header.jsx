    ...
    return (
        <header className="text-center mb-4">
            ...
            <div className="flex justify-center items-center mt-4 space-x-2 md:space-x-4">
                <div
                    className="bg-yellow-100 text-yellow-800 font-bold py-2 px-3 md:px-5 rounded-xl text-md md:text-lg border-2 border-yellow-300">
                    Puntuación: <span>{score}</span>
                </div>
                <div
                    className="bg-purple-100 text-purple-800 font-bold py-2 px-3 md:px-5 rounded-xl text-md md:text-lg border-2 border-purple-300">
