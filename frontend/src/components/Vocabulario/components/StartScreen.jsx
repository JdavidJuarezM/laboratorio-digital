    ...
    return (
        <>
            ...
            <div className="w-full h-full flex items-center justify-center p-2 md:p-4">
                ...
                <div
                    className="card w-full max-w-5xl max-h-[90vh] bg-white rounded-[2rem] shadow-2xl flex flex-col relative overflow-hidden border-4 border-white">
                        ...
                        <div className="w-full max-w-4xl mx-auto flex flex-col gap-4 md:gap-6 justify-center h-full">
                          ...
                          ${settings.difficulty === level
                                            ...
                                            >
                                                ...
                                                />
                                                <span
                                                    className={`text-xs md:text-sm font-black uppercase tracking-wide ${
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span
                                            className="block text-base font-bold text-blue-900">Jugar contra reloj</span>
                                        <span className="text-xs text-blue-600 font-medium">¿Te atreves con el tiempo límite?</span>
                                    </div>
                                </div>
                                <div
                                    className={`w-12 h-7 rounded-full p-1 transition-colors duration-300 ${settings.timerEnabled ? 'bg-blue-500' : 'bg-gray-300'}`}>
                                    <div
                                        className={`bg-white w-5 h-5 rounded-full shadow-md transform transition-transform duration-300 ${settings.timerEnabled ? 'translate-x-5' : 'translate-x-0'}`}></div>
                                </div>
                            </div>
                ...
                <span className="relative z-10 flex items-center justify-center gap-2">
                  <span>🚀</span> ¡COMENZAR!
                                ...
                                <div
                                    className="absolute inset-0 rounded-2xl bg-white/20 blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            </button>
