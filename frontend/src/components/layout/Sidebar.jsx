...
function Sidebar() {
    ...
    return (
        <nav
            className="w-full md:w-80 bg-indigo-600/80 backdrop-blur-xl text-white p-6 shadow-2xl flex flex-col justify-between md:rounded-r-3xl border-r-4 border-indigo-400">
            <div>
