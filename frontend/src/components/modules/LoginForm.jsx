        ...
        <div className="relative w-full overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
            ...
            <div className="relative hidden md:flex flex-col justify-center items-center p-12 bg-[#c4bfb7] animate-slide-in-left overflow-hidden">
              ...
              <div className="absolute w-24 h-24 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full"></div>
              <div className="absolute w-32 h-32 bottom-10 right-20 bg-purple-100 rounded-full opacity-60"></div>
