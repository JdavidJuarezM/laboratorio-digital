...
function LoginForm() {
    ...
    const buttonClasses = ["login-button", "bg-purple-700", "hover:bg-purple-800", "active:scale-[0.98]", "flex", "h-[48px]", "w-full", "items-center", "justify-center", "rounded-lg", "py-3", "font-bold", "text-white", "shadow-lg", "transition", "duration-300", isLoading ? "loading" : "",].join(" ").trim();

    return (<div className="antialiased min-h-screen font-sans">
        <ThreeJSBackground/>
        ...
        <div className="main-container relative min-h-screen z-10">
            <div className="relative w-full overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
                    ...
                    <div
                        className="relative hidden md:flex flex-col justify-center items-center p-12 bg-[#c4bfb7] animate-slide-in-left overflow-hidden">
                        {/* Círculos decorativos (como en tu imagen) */}
                        <div
                            className="absolute w-64 h-64 -top-20 -left-20 bg-purple-200 rounded-full opacity-50"></div>
                        <div
                            className="absolute w-48 h-48 -bottom-24 right-10 bg-purple-200 rounded-full opacity-50"></div>
                        <div
                            className="absolute w-24 h-24 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full"></div>
                        {/* Círculo blanco arriba del logo */}
                        <div
                            className="absolute w-32 h-32 bottom-10 right-20 bg-purple-100 rounded-full opacity-60"></div>
                        {/* Círculo abajo derecha */}


                        {/* Contenido centrado */}
                        <div
                            className="relative z-10 flex flex-col items-center justify-center text-center h-full max-w-md mx-auto">
                        ...
                        <div
                            className="relative z-10 items-center justify-center text-center h-full max-w-md mx-auto">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed px-4">
                                Un espacio donde los estudiantes de la Escuela Primaria <br/> Emiliano Zapata pueden
                                aprender jugando.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        className="relative flex flex-col justify-center p-8 md:p-12 animate-slide-in-right bg-white/30 backdrop-blur-sm">
                        <main
                            id="dynamic-content"
                            className={`w-full max-w-md mx-auto ${isShaking ? "shake" : ""}`}
                        >
                            {isSuccess ? (<SuccessState/>) : (<div>
                        ...
                        {!isSuccess && (<p className="mt-8 text-center text-sm text-gray-200">
